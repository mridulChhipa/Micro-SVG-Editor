...
private:
  QAction *addToolAction(QString name, bool is_toggleable, QActionGroup *action_group = nullptr, QString icon_path = "", QString tooltip = "")
  {
    QAction *action;
...
public:
  LeftToolBar(const QString &title, QWidget *parent = nullptr, QActionGroup *action_group = nullptr) : QToolBar(title, parent)
  {
