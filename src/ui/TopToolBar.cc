...
QAction *TopToolBar::addToolAction(QString name, bool isToggleable, QActionGroup *action_group = nullptr, QString icon_path = "", QString tooltip = "")
{
  QAction *action;
...
TopToolBar::TopToolBar(const QString &title, QWidget *parent = nullptr, QActionGroup *action_group = nullptr) : QToolBar(title, parent)
{
