...
MenuBar::MenuBar(QWidget* parent) : QMenuBar(parent) { SetupMenus(); }
...
void MenuBar::SetupMenus() {
  ...
  connect(save_as_action, &QAction::triggered, this, &MenuBar::saveAsRequested);
  ...
  QAction* zoom_in_action = view_menu->addAction("Zoom In");
  QAction* zoom_out_action = view_menu->addAction("Zoom Out");
  QAction* zoom_reset_action = view_menu->addAction("Reset Zoom");

  connect(zoom_in_action, &QAction::triggered, this, &MenuBar::zoomInRequested);
  connect(zoom_out_action, &QAction::triggered, this,
          &MenuBar::zoomOutRequested);
  connect(zoom_reset_action, &QAction::triggered, this,
          &MenuBar::zoomResetRequested);
}
