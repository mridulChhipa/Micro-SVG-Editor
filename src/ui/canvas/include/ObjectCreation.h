...
inline void Canvas::createObject(const GraphicsObjectPtr &obj, QPainterPath &path, QPen &pen)
{
...
inline QTransform Canvas::findTransform(const GraphicsObjectPtr &obj)
{
...
inline void Canvas::applyDashArray(QPen &pen, const std::string &dasharray)
{
